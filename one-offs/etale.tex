...
\begin{remark}
	Here is another way to construct the cycle class map is to use Chern classes, which amounts to the data of a map
	\[\op{Pic}(X)\to\mathrm H^2(X)(1).\]
\end{remark}
...
\subsection{Fixing \texorpdfstring{$H^0$}{ H0}}
