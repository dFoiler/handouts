...
\end{exe}
\begin{remark}
	It is possible to formulate and prove a theorm which simultaneously generalizes \Cref{thm:crt-more-eqs,thm:crt-no-coprime}. The interested reader is encouraged to attempt this exercise.
\end{remark}
